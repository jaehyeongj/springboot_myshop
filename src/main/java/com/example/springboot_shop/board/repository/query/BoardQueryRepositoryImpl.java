...
import static com.example.springboot_shop.board.entity.QBoard.board;
import static com.example.springboot_shop.like.entity.QLike.like;
...
public class BoardQueryRepositoryImpl implements BoardQueryRepository {
    ...
    public List<Board> searchBoard(String searchName) {
        ...
        return jpaQueryFactory
                .select(Projections.constructor(Board.class,
                        ...
                        board.content,
                        board.modifiedAt,
                        board.member.profile.profileImage,
                        like.count()

                ))
                .from(board)
                .where(
                        board.content.contains(searchName).or(
                                board.nickname.contains(searchName
                                ))
                )
                .fetch();
